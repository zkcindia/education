...
export default function signUp() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#fff', padding: 15 }}>
      ...
      <Text style={{ fontFamily: 'roboto-bold', textAlign: 'center', fontSize: 30 }}>
        Sign In
      </Text>

      <Text style={{ fontSize: 16, marginHorizontal: 'auto', marginTop: 5, fontFamily: 'roboto' }}>
      ...
      <View style={{ display: 'flex', flexDirection: 'column', gap: 15, marginTop: 30 }}>
        ...
        <View style={{ display: 'flex', flexDirection: 'column', marginBottom: 15 }}>
          <Text style={{ fontSize: 16, fontFamily: 'roboto-medium', marginBottom: 5 }}>
            Password
          </Text>
        ...
        <TouchableOpacity
          style={{ backgroundColor: '#003096', padding: 15, borderRadius: 10 }}
          onPress={handleLogin}
        >
          <Text style={{ fontSize: 20, fontFamily: 'roboto-bold', color: '#fff', textAlign: 'center' }}>
            SIGN IN
          </Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={{ display: 'flex', flexDirection: 'row', gap: 10, justifyContent: 'center', marginTop: 30 }}>
        <Text style={{ fontFamily: 'roboto', textAlign: 'center' }}>
